...
| Your order. | 2 | Pass |
| Each site. | 2 | Pass |
| Choose a caption default and rank up to four languages for each site. | 13 | Pass |
| It reads only the current site's name. | 7 | Pass |
| Pick captions on or off, then rank your languages. | 9 | Pass |
| Use the button or keyboard shortcut on a supported player. | 10 | Pass |
| No subtitle downloads. | 3 | Pass |
| No translation or caption generation. | 5 | Pass |
| No DRM changes. | 3 | Pass |
...
| It changes player controls, not video files | 7 | Pass |
...
| Player without usable controls | unsupported player |
